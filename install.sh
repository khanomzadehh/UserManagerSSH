...
if [ $# == 0 ]; then
link=$(sudo curl -Ls "https://api.github.com/repos/khanomzadehh/UserManagerSSH/releases/latest" | grep '"browser_download_url":' | sed -E 's/.*"([^"]+)".*/\1/')
...
link="https://github.com/khanomzadehh/UserManagerSSH/releases/download/$last_version/$lastzip.zip"
...
bash <(curl -Ls https://raw.githubusercontent.com/khanomzadehh/UserManagerSSH/Requirements/ioncube-loader/main/install.sh --ipv4)
fi
...
bash <(curl -Ls https://raw.githubusercontent.com/khanomzadehh/UserManagerSSH/Requirements/Nethogs-Json/main/install.sh --ipv4)
fi
...
crontab -l | grep -v 'khanomzadehh/UserManagerSSH/master/install.sh'  | crontab  -
(crontab -l ; echo "1 1-23/2 * * * php /var/www/html/p/versioncheck.php >/dev/null 2>&1
4 4 * * * bash <(curl -Ls https://raw.githubusercontent.com/khanomzadehh/UserManagerSSH/master/install.sh --ipv4)
...
sudo wget -4 -O /var/www/html/n.apk https://github.com/khanomzadehh/UserManagerSSH/raw/main/n.apk &
wait
fi
...
sudo wget -4 -O /var/www/html/n.apk https://github.com/khanomzadehh/UserManagerSSH/raw/main/h.apk &
wait
fi
...
bash <(curl -Ls https://raw.githubusercontent.com/khanomzadehh/UserManagerSSH/main/t.sh --ipv4)
fi
